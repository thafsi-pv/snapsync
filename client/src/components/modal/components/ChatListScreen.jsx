...
function ChatListScreen({
  ...
  return (
    <div className="relative  w-full flex flex-col justify-between h-full pb-safe" style={{paddingTop:"env(safe-area-inset-top)",paddingBottom:"env(safe-area-inset-bottom)"}}>
