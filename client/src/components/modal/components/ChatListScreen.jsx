            ...
            <div className="flex flex-col items-start max-w-xs mx-auto mb-4  bg-gray-100 rounded-lg">
              ...
              <div className="p-4">
                <p className="text-sm text-gray-700 line-clamp-3">
                  ...
                  👉 Regular Expression | RegEx | JavaScript | In Detail 🔔
                  Follow me @codebustler for more content like this. Don't
                  Forget To Like ♥️ | Share 📲 | Save 📥
                  ----------------------------------------- #regex
                  #webdevelopment #computerscience #html #css #javascript
                  #coders #fullstack #codingisfun #codingbootcamp
                  #codingchallenge #learncode #reactjs #vscode #programmerslife
                  #100daysofcode #csstricks #100daysofcodechallenge #frontenddev
                  #codebustler #frontenddeveloper #frontendengineer #html5
